package com.satriaamrudito.thehappyplaceap.callback
...
abstract class SwipeToEditCallback(context: Context) :
    ...
    override fun onChildDraw(
        ...
        val itemHeight = itemView.bottom.toFloat()
        ...
        editIcon!!.setBounds(editIconLeft.toInt(),
            editIconTop.toInt(), editIconRight.toInt(), editIconBottom.toInt()
        )
        editIcon.draw(c)
